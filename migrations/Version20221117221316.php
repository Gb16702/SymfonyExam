...
final class Version20221117221316 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE voitures (id INT AUTO_INCREMENT NOT NULL, marque_id INT NOT NULL, user_id INT NOT NULL, nom VARCHAR(255) NOT NULL, prix NUMERIC(8, 2) NOT NULL, km INT NOT NULL, titre VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, carburant VARCHAR(255) NOT NULL, slug VARCHAR(100) NOT NULL, owner INT DEFAULT NULL, INDEX IDX_8B58301B4827B9B2 (marque_id), INDEX IDX_8B58301BA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
